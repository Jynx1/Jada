# Jassmine.sh documentation #
	Version: V1.02-27-17.12.52A
	Last Update: 06/21/2018
* Latest status: Uploaded files to Git Hub

## Introduction ##
Menu driven bash shell script to get
information about a Linux server / desktop and Do
some User and File operations Quickly.
...
Jassmine.sh runs on Eve. This is the first modual

## Table of contents ##

* [[Installation]]

    File can be started via the terminal window. place Jassmine.sh in the Bin directory.
...
# Jasminee.sh test
#######################################################
# DESCRIPTION: Menu driven shell script to to get
# information about  your Linux server / desktop and Do
# some Users and File operations Quickly.
#######################################################
# Bash File
# Jacky's Profile
# Lines of Code:
